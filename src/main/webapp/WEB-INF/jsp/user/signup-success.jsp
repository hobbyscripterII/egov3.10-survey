...
<div id="div-signup-success-form">
	<p><a href="https://www.flaticon.com/kr/free-icon/key-person_14820457" title="열쇠를 쥐고있는 사람 아이콘" target="_blank"><img id="img-icon-megaphone" alt="열쇠를 쥐고있는 사람 아이콘" src="${pageContext.request.contextPath }/images/egovframework/icon-keyman.png"></a></p>
...
document.getElementById('btn-login').addEventListener('click', () => {
	location.href = '/survey/user/signin.do';
});
</script>
