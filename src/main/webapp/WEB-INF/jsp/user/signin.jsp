...
<div id="div-signin-wrap">
	<form:form commandName="dto" id="f" action="signin.do" method="post">
	    ...
	    <button type="button" class="btn btn-secondary btn-lg btn-signin" onclick="location.href='/survey/user/signup.do'">회원가입</button>
	</form:form>
</div>
</body>
</html>
...
document.addEventListener('keyup', (e) => { if(window.event.keyCode == 13) { signIn(); } });
